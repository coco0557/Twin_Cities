...
$pois = \TwinCities\getPlacesByCityId(1);
?>
...
<head>
  ...
  <title>Barcelona Explorer</title>
...
<body class="bg-blue-950 text-white">
  <div class="max-w-7xl mx-auto px-4 py-6">
    ...
    <div class="bg-slate-800 w-full border-2 border-blue-700 rounded-xl p-6 md:p-10 mb-6">
    <p class="text-xs font-mono tracking-widest uppercase text-blue-300 mb-2">
      ...
      <p class="mt-3 text-blue-100 text-sm max-w-2xl">
        Discover places of interest across Barcelona. Click a marker or a place in the list to view more details.
      </p>
    </div>
    ...
    <div class="grid grid-cols-1 xl:grid-cols-3 gap-6">
      ...
      <div class="xl:col-span-2">
        <div class="bg-slate-800 border-2 border-blue-700 rounded-xl p-4">
          <div id="barcelonaMap" class="map-box"></div>
        </div>
      </div>

      <div class="xl:col-span-1">
        <div class="bg-slate-800 border-2 border-blue-700 rounded-xl p-4 h-full">
          <div class="flex items-center justify-between mb-4">
            <h2 class="font-mono font-bold text-xl text-white">
              <i class="fa-solid fa-list mr-2 text-blue-400"></i>Places of Interest
            </h2>
            <span class="text-sm text-blue-300 font-mono"><?php echo count($pois); ?> total</span>
          </div>
            ...
            <?php foreach ($pois as $poi): ?>
              <a href="frontdetails.php?place_id=<?php echo $poi['place_id']; ?>"
                ...
                <?php if (!empty($poi['capacity'])): ?>
                  <p class="text-xs text-blue-300 mt-2 font-mono">
    ...
    <div class="flex justify-center mt-6">
      <a href="map-3.php" class="flex items-center gap-2 bg-blue-700 hover:bg-blue-600 text-white font-mono font-bold px-6 py-3 rounded-lg transition-colors duration-200">
  ...
  <script>
    ...
    const barcelonaIcon = L.divIcon({
      html: `
        <div class="w-5 h-5 bg-blue-600 rotate-[-45deg] rounded-[50%_50%_50%_0%] border-2 border-white shadow-md"></div>
      `,
      className: "",
      iconSize: [20, 20],
      iconAnchor: [10, 20]
